...
const MinimaxTicTacToePage: React.FC = () => {
    return (
        <AboutContainer maxWidth="lg">
            ...
            <Typography variant="body1" color="text.secondary" mt={2}>
                Here is the Python code of the Tic Tac Toe game AI. It uses the minimax algorithm to calculate the best move.
            </Typography>
...
export default MinimaxTicTacToePage;

...
const AboutPage: React.FC = () => {
    return (
        ...
        <Typography variant="body1" color="text.secondary" mt={2}>
            Here is the Python code of the Chess game AI. It uses the minimax algorithm along with a trained Convolutional Neural Network to calculate the best move. The board positions are evaluated using the Stockfish chess engine and are used to train the network.
        </Typography>

            <Highlight language="python">
                {pythonCode}
            </Highlight>
            <PlayButton variant="outlined" color="primary" startIcon={<PlayCircleOutline />}>
                Play
            </PlayButton>
        </AboutContainer>
    );
